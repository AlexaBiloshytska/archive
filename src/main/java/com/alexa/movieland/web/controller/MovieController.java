...
public class MovieController {
    ...
    @GetMapping
    public List<MovieLto> getAll(List<SortingEnum> sortingEnums) {
        return movieMapper.map(movieService.getAll(sortingEnums));
    }
    ...
    public List<Movie> getMoviesByGenre(@RequestParam int genreId, List<SortingEnum> sortingEnums){
        return movieService.getMoviesByGenre(genreId,sortingEnums);
    }
}
